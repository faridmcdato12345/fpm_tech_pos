<template>
    ...
    <Head title="Voided Transaction" />
    <AuthenticatedLayout>
        <BreadCrumb title="Voided Transactions" :bread-crumbs="breadCrumbs" />
...
const page = usePage()
const exportLink = [
    { id: 1, name: 'excel', url: route('voided_transaction.excel') },
    { id: 2, name: 'pdf', url: route('voided_transaction.pdf') }
]
onMounted(() => {
...
const columns = ref([
    ...
    { label: 'PRICE', key: 'total_selling_price' },
])
