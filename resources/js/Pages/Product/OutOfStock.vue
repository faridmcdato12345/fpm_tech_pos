<template>
    ...
    <AuthenticatedLayout>
        <BreadCrumb title="Out of Stock Products" :bread-crumbs="breadCrumbs">
        </BreadCrumb>
...
const exportLink = [
    { id: 1, name: 'excel', url: route('out_of_stock.excel') },
    { id: 2, name: 'pdf', url: route('out_of_stock.pdf') }
]
const columns = ref([
    { label: 'ID', key: 'id' },
...
const breadCrumbs = ref([
    { label: 'Out-of-Stock Products List', route: route('product.index'), id: 1 }
])
const limitQuery = (name, e) => {
    ...
    router.get(route('out_of_stock.index', params))
}
